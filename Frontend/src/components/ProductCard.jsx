    ...
    return (
        <div className="border rounded-lg p-2 shadow hover:shadow-lg flex flex-col">
            ...
            <div className="flex w-full space-x-2 mt-2">
                <button className="bg-blue-600 text-white h-9 rounded flex-[3] truncate hover:bg-blue-700 active:bg-blue-900 active:scale-95 transition cursor-pointer" style={{ padding: '2%', fontSize: 'clamp(0.6rem, 0.8vw, 1rem)' }}>Thêm vào giỏ</button>
                <select className="border h-9 rounded flex-1" style={{ padding: '3%', fontSize: 'clamp(0.6rem, 0.8vw, 1rem)' }}>
